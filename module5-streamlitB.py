...
psa_file = st.file_uploader("",type=['aln-fasta','clustal_num'])
    ...
    for line in temp_split:
        ...
        if any(char in "*:. " for char in line):
            ...
            if line.startswith(" "):
                ...
                symbols = line[28:] #.strip() #not using .strip() bc i need spaces; dropping the first 26 bc that seems to be the number of excess at the front in the file (should be consistent btwn alignments)
